...
const previewingTimeout = ref<ReturnType<typeof setTimeout> | null>(null);
...
function clearPreviewTimeout() {
	if (previewingTimeout.value)
		clearTimeout(previewingTimeout.value);
	previewingTimeout.value = null;
}
...
<template>
	<button
		...
		aria-label="Temporarily preview the back of this card"
