...
import type { PlayerHistoryColumnConfig, PlayerHistoryModeConfig } from '~~/shared/types/screenConfig';
...
function updateRotationShape(patch: Partial<PlayerHistoryModeConfig>) {
