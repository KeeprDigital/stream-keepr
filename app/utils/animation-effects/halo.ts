// @ts-nocheck
import ShaderBase, {ANIMATION_EFFECTS} from './shaderBase'
...
class Halo extends ShaderBase {
  ...
  onDestroy() {
    ...
    if (this.bufferFeedback) this.bufferFeedback.dispose()
    this.bufferTarget = null
    this.bufferFeedback = null
  }
}
export default ANIMATION_EFFECTS.register('HALO', Halo)
