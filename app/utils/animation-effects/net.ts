// @ts-nocheck
import AnimationBase, {ANIMATION_EFFECTS} from './base'
import {rn, ri, mobileCheck, getBrightness} from './helpers'

const win = typeof window == 'object'
let THREE = win && window.THREE

class Effect extends AnimationBase {
  static initClass() {
  ...
  onDestroy() {
    // Leave linesMesh in the scene so base destroy()'s clearThree(scene) disposes its geometry/material
...
Effect.initClass()
export default ANIMATION_EFFECTS.register('NET', Effect)