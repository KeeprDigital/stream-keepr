...
- **Status**: Accepted
- **Date**: 2026-08-05
- **Amended**: twice, both times by a fresh-context review of PR [#226](https://github.com/KeeprDigital/stream-keepr/pull/226). 2026-08-05 under [#199](https://github.com/KeeprDigital/stream-keepr/issues/199), which named the cost the narrowing argument below was carrying; 2026-08-06 under [#229](https://github.com/KeeprDigital/stream-keepr/issues/229), which removed that cost from the live path and retracted the narrowing argument with it. The decision is unchanged. See _Why_ and _Consequences_.
