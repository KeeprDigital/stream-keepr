...
If the needed concept isn't in the glossary, either the proposed language does not match the project or the glossary has a real gap. Reconsider it or note it for `/domain-modeling`.
