...
- It has pixel dimensions, overlay/fill/key output modes, anchors, geometry, Graphic Layer Order, styles, frame media, and existing animation effects ([screen config](../../shared/types/screenConfig.ts#L189-L337)).
...
- its instance id and Graphic Layer Order on the Broadcast Graphics Screen;
- Graphic Input Bindings to Event Data;
