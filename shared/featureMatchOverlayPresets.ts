...
neonFeatureMatch.layout.items = [
	...
	},
	{
		...
		overflow: 'clip',
		children: [
			{ id: 'p1-wins', label: 'Player 1 Wins', visible: true, type: 'graphic-item', graphicItem: { type: 'game-wins', playerSide: 'player1', displayMode: 'boxes', boxOrientation: 'horizontal', boxWidth: 22, boxHeight: 22, boxGap: 4, boxBorderWidth: 3 }, layout: { mode: 'canvas', x: 48, y: 46, width: 36, height: 30 }, surfaceStyle: { backgroundColor: '#ffffff', backgroundOpacity: 0, borderColor: '#ffffff', borderRadius: 0 } },
			{ id: 'p1-life', label: 'Player 1 Life', visible: true, type: 'graphic-item', graphicItem: { type: 'player-life', playerSide: 'player1', lifeAnimation: 'glow', lifeAnimationDurationMs: 420, lifeAnimationAccentColor: '#ffffff' }, layout: { mode: 'canvas', x: 88, y: 28, width: 60, height: 60 }, surfaceStyle: { backgroundColor: '#7c0f5b', backgroundOpacity: 0.72, borderVisible: true, borderColor: '#ffffff', borderWidth: 4, borderRadius: 0, textColor: '#ffffff', fontSize: 32, fontWeight: 900, textAlign: 'center', glowColor: '#ffffff', glowSize: 7, glowOpacity: 0.75 } },
			{ id: 'p1-name', label: 'Player 1 Name', visible: true, type: 'graphic-item', graphicItem: { type: 'text', playerSide: 'player1', template: '{name}' }, layout: { mode: 'canvas', x: 162, y: 24, width: 590, height: 44 }, surfaceStyle: { fontSize: 34, fontWeight: 900, lineHeight: 1, overflow: 'ellipsis' } },
			{ id: 'p1-record-deck', label: 'Player 1 Record and Deck', visible: true, type: 'graphic-item', graphicItem: { type: 'text', playerSide: 'player1', template: '{record}     {deck}' }, layout: { mode: 'canvas', x: 164, y: 68, width: 620, height: 32 }, surfaceStyle: { fontSize: 22, fontWeight: 500, lineHeight: 1, overflow: 'ellipsis' } },
			{ id: 'p2-name', label: 'Player 2 Name', visible: true, type: 'graphic-item', graphicItem: { type: 'text', playerSide: 'player2', template: '{name}' }, layout: { mode: 'canvas', x: 1168, y: 24, width: 590, height: 44 }, surfaceStyle: { fontSize: 34, fontWeight: 900, lineHeight: 1, textAlign: 'right', overflow: 'ellipsis' } },
			{ id: 'p2-record-deck', label: 'Player 2 Record and Deck', visible: true, type: 'graphic-item', graphicItem: { type: 'text', playerSide: 'player2', template: '{deck}     {record}' }, layout: { mode: 'canvas', x: 1136, y: 68, width: 620, height: 32 }, surfaceStyle: { fontSize: 22, fontWeight: 500, lineHeight: 1, textAlign: 'right', overflow: 'ellipsis' } },
			{ id: 'p2-life', label: 'Player 2 Life', visible: true, type: 'graphic-item', graphicItem: { type: 'player-life', playerSide: 'player2', lifeAnimation: 'glow', lifeAnimationDurationMs: 420, lifeAnimationAccentColor: '#ffffff' }, layout: { mode: 'canvas', x: 1772, y: 28, width: 60, height: 60 }, surfaceStyle: { backgroundColor: '#53128c', backgroundOpacity: 0.72, borderVisible: true, borderColor: '#ffffff', borderWidth: 4, borderRadius: 0, textColor: '#ffffff', fontSize: 32, fontWeight: 900, textAlign: 'center', glowColor: '#ffffff', glowSize: 7, glowOpacity: 0.75 } },
			{ id: 'p2-wins', label: 'Player 2 Wins', visible: true, type: 'graphic-item', graphicItem: { type: 'game-wins', playerSide: 'player2', displayMode: 'boxes', boxOrientation: 'horizontal', boxWidth: 22, boxHeight: 22, boxGap: 4, boxBorderWidth: 3 }, layout: { mode: 'canvas', x: 1838, y: 46, width: 36, height: 30 }, surfaceStyle: { backgroundColor: '#ffffff', backgroundOpacity: 0, borderColor: '#ffffff', borderRadius: 0 } },
		],
	},
	{
		id: 'round-clock',
		...
		overflow: 'clip',
		children: [
			{ id: 'round-label', label: 'Round', visible: true, type: 'graphic-item', graphicItem: { type: 'text', template: '{round}' }, layout: { mode: 'canvas', x: 12, y: 20, width: 192, height: 34 }, surfaceStyle: { fontSize: 26, fontWeight: 900, textAlign: 'center', lineHeight: 1 } },
			{ id: 'match-clock', label: 'Clock', visible: true, type: 'graphic-item', graphicItem: { type: 'clock' }, layout: { mode: 'canvas', x: 12, y: 62, width: 192, height: 38 }, surfaceStyle: { fontSize: 32, fontWeight: 400, textAlign: 'center', lineHeight: 1 } },
		],
	},
	{ id: 'upper-neon-rail', type: 'graphic-group', label: 'Upper Neon Rail', visible: true, x: 0, y: 144, width: 1920, height: 64, surfaceStyle: { backgroundOpacity: 0, borderVisible: true, borderColor: '#ffffff', borderWidth: 3, borderTopVisible: false, borderLeftVisible: false, borderRightVisible: false, glowColor: '#ffffff', glowSize: 8, glowOpacity: 0.8 }, defaultChildSurfaceStyle: {}, arrangement: { mode: 'canvas', padding: 0 }, overflow: 'clip', children: [] },
	{ id: 'left-empty-panel', type: 'graphic-group', label: 'Left Upper Branding Panel', visible: true, x: 0, y: 508, width: 296, height: 104, surfaceStyle: { backgroundOpacity: 1, backgroundGradient: 'linear-gradient(180deg, rgba(10,0,16,0.76), rgba(78,0,67,0.58))', borderVisible: true, borderColor: '#ffffff', borderWidth: 3, borderLeftVisible: false, borderRightVisible: true, glowColor: '#ffffff', glowSize: 7, glowOpacity: 0.78 }, defaultChildSurfaceStyle: {}, arrangement: { mode: 'canvas', padding: 0 }, overflow: 'clip', children: [] },
	{
		id: 'left-branding',
		type: 'graphic-group',
		label: 'Left Branding',
		...
		overflow: 'clip',
		children: [
			{ id: 'left-branding-image', label: 'Left Branding Image', visible: false, type: 'media', mediaKind: 'image', fit: 'contain', focalPosition: { horizontal: 0.5, vertical: 0.5 }, opacity: 1, layout: { mode: 'canvas', x: 40, y: 28, width: 216, height: 112 } },
			{ id: 'left-event-name', label: 'Event Name', visible: true, type: 'graphic-item', graphicItem: { type: 'text', template: '{eventName}' }, layout: { mode: 'canvas', x: 24, y: 152, width: 248, height: 56 }, surfaceStyle: { fontSize: 28, fontWeight: 900, textAlign: 'center', lineHeight: 1.05, overflow: 'shrink' } },
		],
	},
	{ id: 'left-footer-panel', type: 'graphic-group', label: 'Left Footer Panel', visible: true, x: 0, y: 864, width: 296, height: 208, surfaceStyle: { backgroundOpacity: 1, backgroundGradient: 'linear-gradient(180deg, rgba(9,0,18,0.82), rgba(81,0,73,0.62))', borderVisible: true, borderColor: '#ffffff', borderWidth: 3, borderTopVisible: false, borderLeftVisible: false, borderRightVisible: true, glowColor: '#ffffff', glowSize: 7, glowOpacity: 0.78 }, defaultChildSurfaceStyle: {}, arrangement: { mode: 'canvas', padding: 0 }, overflow: 'clip', children: [] },
	{
		id: 'right-branding',
		type: 'graphic-group',
		...
		overflow: 'clip',
		children: [
			{ id: 'right-branding-image', label: 'Right Branding Image', visible: false, type: 'media', mediaKind: 'image', fit: 'contain', focalPosition: { horizontal: 0.5, vertical: 0.5 }, opacity: 1, layout: { mode: 'canvas', x: 42, y: 52, width: 212, height: 158 } },
			{ id: 'right-event-name', label: 'Event Name', visible: true, type: 'graphic-item', graphicItem: { type: 'text', template: '{eventName}' }, layout: { mode: 'canvas', x: 24, y: 232, width: 248, height: 56 }, surfaceStyle: { fontSize: 28, fontWeight: 900, textAlign: 'center', lineHeight: 1.05, overflow: 'shrink' } },
		],
	},
	{ id: 'right-footer-panel', type: 'graphic-group', label: 'Right Footer Panel', visible: true, x: 1624, y: 864, width: 296, height: 208, surfaceStyle: { backgroundOpacity: 1, backgroundGradient: 'linear-gradient(180deg, rgba(81,0,110,0.62), rgba(9,0,18,0.86))', borderVisible: true, borderColor: '#ffffff', borderWidth: 3, borderTopVisible: false, borderLeftVisible: true, borderRightVisible: false, glowColor: '#ffffff', glowSize: 7, glowOpacity: 0.78 }, defaultChildSurfaceStyle: {}, arrangement: { mode: 'canvas', padding: 0 }, overflow: 'clip', children: [] },
];
