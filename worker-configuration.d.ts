/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.dev.jsonc` (hash: 6001daf7f7ce565f7fbf720a424842ec)
// Runtime types generated with workerd@1.20260721.1 2026-07-16 no_nodejs_compat_v2,nodejs_compat
interface __BaseEnv_Env {
	KV: KVNamespace;
	GRAPHICS_ASSET_STAGING: R2Bucket;
	GRAPHICS_ASSET_CANONICAL: R2Bucket;
	DB: D1Database;
	NUXT_ABLY_API_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NUXT_ABLY_API_KEY">> {}
}
